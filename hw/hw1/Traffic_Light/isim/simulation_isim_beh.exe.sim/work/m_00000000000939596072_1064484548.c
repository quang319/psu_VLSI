...
#endif
static const char *ng0 = "cnt = %3d , EMG = %b , lights = %b_%b";
static const char *ng1 = "C:/Users/quang/Dropbox/School/Penn State/Spring/CSE 557 - VLSI/Traffic_Light/simulation.v";
static int ng2[] = {0, 0};
static int ng3[] = {1, 0};

void Monitor_46_1(char *);
void Monitor_63_5(char *);
void Monitor_46_1(char *);
void Monitor_63_5(char *);
...
LAB0:    t1 = (t0 + 1768);
    ...
    *((unsigned int *)t18) = (t26 & 15U);
    xsi_vlogfile_write(1, 0, 3, ng0, 5, t0, (char)118, t3, 1, (char)118, t6, 1, (char)118, t7, 4, (char)118, t17, 4);

LAB1:    return;
}

static void Monitor_63_5_Func(char *t0)
{
    char t7[8];
    char t17[8];
    char *t1;
...
LAB0:    t1 = (t0 + 3736);
    t2 = (t0 + 4280);
    xsi_vlogfile_monitor((void *)Monitor_63_5_Func, t1, t2);

LAB1:    return;
}


extern void work_m_00000000000939596072_1064484548_init()
{
	static char *pe[] = {(void *)Initial_42_0,(void *)Always_53_2,(void *)Always_57_3,(void *)Always_62_4,(void *)Monitor_46_1,(void *)Monitor_63_5};
	xsi_register_didat("work_m_00000000000939596072_1064484548", "isim/simulation_isim_beh.exe.sim/work/m_00000000000939596072_1064484548.didat");
